...
int main() {
    ...
    chen_tap_tin(&thu_muc, "file1.txt", 10485760, "2024-11-01 12:00:00"); // 10 MB
    chen_tap_tin(&thu_muc, "file2.txt", 20971520, "2024-11-03 15:30:00"); // 20 MB
    chen_tap_tin(&thu_muc, "file3.txt", 5242880, "2024-11-02 09:45:00");  // 5 MB
